...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
           ...
           <table >
           <tr>
           <td ><img alt="" height="120px" src="<%=request.getContextPath() %>/js/dggf.jpg"></td>
           </tr>
     ...
     <div >
              <img src="<%=request.getContextPath() %>/logoquan15076917456.PNG" class="img-thumbnail" />


       </div>
<!-- 	树 -->
		<div >
			<div id="tree-div" style="color:blue"></div>
		</div>
<!-- 		选项卡 -->
  ...
  <div id="page-wrapper">
         ...
         <div >
            ...
            <div class="tab-content"></div>
                             ...
                             <!-- 中间开始 -->
             <img src="<%=request.getContextPath() %>/8c8b4dac43b9a1ff06d31bdf4f514703.jpg"  />
...
function getTreeData(){
        ...
        $.ajax({
            url:"<%=request.getContextPath()%>/user/queryTree.action?userid="+userid,
            type:"post",
            dataType:"json",
            async:false,
